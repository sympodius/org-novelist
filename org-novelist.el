...
export files."
  ...
  (catch 'EXPORT-STORY-FAULT
    (let* ((story-folder (orgn--story-root-folder))
           ...
           keys
           key
           (org-export-backends-orig org-export-backends)
           (org-export-with-toc-orig org-export-with-toc)
           (org-export-with-date-orig org-export-with-date)
           (org-export-with-tags-orig org-export-with-tags)
           (org-export-with-email-orig org-export-with-email)
           (org-export-with-latex-orig org-export-with-latex)
           (org-export-with-tasks-orig org-export-with-tasks)
           (org-export-with-title-orig org-export-with-title)
           (org-export-with-author-orig org-export-with-author)
           (org-export-with-clocks-orig org-export-with-clocks)
           (org-export-with-tables-orig org-export-with-tables)
           (org-export-with-creator-orig org-export-with-creator)
           (org-export-with-drawers-orig org-export-with-drawers)
           (org-export-with-entities-orig org-export-with-entities)
           (org-export-with-planning-orig org-export-with-planning)
           (org-export-with-priority-orig org-export-with-priority)
           (org-export-with-emphasize-orig org-export-with-emphasize)
           (org-export-with-footnotes-orig org-export-with-footnotes)
           (org-export-with-properties-orig org-export-with-properties)
           (org-export-with-timestamps-orig org-export-with-timestamps)
           (org-export-with-fixed-width-orig org-export-with-fixed-width)
           (org-export-with-inlinetasks-orig org-export-with-inlinetasks)
           (org-export-with-broken-links-orig org-export-with-broken-links)
           (org-export-with-smart-quotes-orig org-export-with-smart-quotes)
           (org-export-with-todo-keywords-orig org-export-with-todo-keywords)
           (org-export-with-archived-trees-orig org-export-with-archived-trees)
           (org-export-with-section-numbers-orig org-export-with-section-numbers)
           (org-export-with-special-strings-orig org-export-with-special-strings)
           (org-export-with-sub-superscripts-orig org-export-with-sub-superscripts)
           (org-use-sub-superscripts-orig org-use-sub-superscripts)
           (org-export-with-statistics-cookies-orig org-export-with-statistics-cookies))
      (setq orgn--autoref-p orgn-automatic-referencing-p)
      (setq orgn-automatic-referencing-p nil)
      ;; Temporarily add a hook to reset automatic referencing in case user aborts minibuffer.
      (add-hook 'post-command-hook 'orgn--reset-automatic-referencing)
