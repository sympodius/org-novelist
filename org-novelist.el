...
;;;; Language Packs
;; Add the language-packs folder to the load-path
(let ((dir (file-name-directory load-file-name)))
  (add-to-list 'load-path (expand-file-name "language-packs" dir)))
;; Load the default language pack (which is used as a fallback)
(require 'org-novelist-language-pack-en-GB)
